...
if (isset($_POST['hero-form'])) {
    ...
    $sql_rdv = "INSERT INTO rdv(date_rdv, maladie, utilisateur_id) VALUES ('$date_rendezvous', '$maladie', (SELECT id FROM Utilisateur WHERE nom = '$nom' and prenom = '$prenom' LIMIT 1))";
